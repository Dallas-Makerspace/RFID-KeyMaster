...
class LargeMachineController(Controller):
    ...
    def setup(self):
        ...
        self.timer = None
        self.bypass_startup_current_check = False
        ...
        if 'timeout_time' in self.config:
            ...
            logging.info('Inactivity Timeout Time is ' +str(self.timeout_time)+' seconds')
                ...
                if state == self.STATE_IDLE:
                    ...
                    if event_type == self.EVENT_AUTH:
                        ...
                        if message['authorized']:
                            authId = message['id']
                            if self.currentsense.getValue() and  not self.bypass_startup_current_check:
                    ...
                    # if startup check was disable, should never get here, but check Juuuust in case
                    if event_type == self.EVENT_CURRENT_SENSE and not self.bypass_startup_current_check:
